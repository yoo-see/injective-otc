...
const BuyList = () => {
  ...
  const tags = (
    <tr className="h-[66px] ">
      ...
      <td className="align-middle gap-2 p-0">
        ...
        <table className="w-[884px] Pretendard text-[#FFFFFF] font-normal text-[15px] leading-[18px]">
          <thead className="h-10 Pretendard text-[#FFFFFF]  font-normal text-[15px] leading-[18px]">
            <tr className="text-left ">
              <th className="pl-3 font-normal p-0">All</th>
              <th className="font-normal p-0">Price</th>
              <th className="font-normal p-0">Collateral</th>
              <th className="font-normal p-0">Time</th>
              <th className="font-normal text-center p-0">Transaction</th>
            </tr>
          </thead>
          <tbody className="max-h-594px font-normal overflow-y-scroll">
            <tr className="h-[66px]">
              <td className="align-middle">
                <div className="flex items-center gap-2 ml-3 p-0">
                  <div>1.</div>
