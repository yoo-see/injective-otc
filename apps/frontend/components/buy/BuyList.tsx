    ...
    <section className="">
      ...
      <body className="mt-5">
        <table className="block w-[884px] Pretendard text-[#FFFFFF] font-normal text-[15px] leading-[18px]">
          <thead className="h-10 Pretendard text-[#FFFFFF]  font-normal text-[15px] leading-[18px] bg-[#22252E]">
          ...
          <tbody className="block w-full max-h-[594px] font-normal overflow-y-scroll">
            <tr className="h-[66px] w-ful">
