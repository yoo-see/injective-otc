...
const BoardItem: React.FC<Props> = ({ activeTab }) => {
  return (
    <div className="bg-[#1F212C] px-6 pt-6 pb-[34px] rounded-[20px]">
      ...
      <div className="flex items-end mt-5">
        <div className="w-full">
          <p className="font-normal text-[15px] text-white mb-3">Amount</p>
          <div className="bg-[#383943] rounded-[10px] py-4 px-5 flex items-center justify-between">
            ...
            <p className="font-medium text-[32px] text-white">300.00</p>
          </div>
        </div>
